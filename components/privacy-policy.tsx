...
const PrivacyPolicy = () => {
  return (
    <div style={{ width: "80%", margin: "auto", padding: "20px 5px" }}>
      <strong>Privacy Policy</strong>{" "}
      <p>
        Alamgir Ahamed built the dbss | dollar buy sale store app as a Free app.
        This SERVICE is provided by Alamgir Ahamed at no cost and is intended
        for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at dbss | dollar buy sale
        store unless otherwise defined in this Privacy Policy.
      </p>{" "}
      <p>
      ...
      <p>This policy is effective as of 2022-09-14</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at alamgir72430@gmail.com.
      </p>{" "}
    </div>
  );
};
